...
<head>
    ...
    <meta name="title" content="فارادي">
            ...
            <ul class="list-group">
                <li class="list-group-item">
                    ...
                    <div class="collapse show" id="Privacy">
                        <div class="card card-body">
                            <p>
                                يركز تطبيق فاراداي على مساعدة طلاب المدارس في عدد من الدول العربية، من خلال تقديم شروح مبسطة للمناهج الدراسية، من المرحلة الابتدائية، وحتى المرحلة الثانوية.
                                ...
                                واحدة من الخدمات الهامة، التي تقدمها منصة «فارادي»، والتي تُمكّن الطالب من طرح أي سؤال يواجهه، في مختلف المناهج التي يدرسها، ويتلقى جوابًا عليه، في شكل من أشكال التفاعل المميز للمنصات الجيدة للتعلم عبر الإنترنت
                            </p>
                        </div>
                    </div>
                </li>
                <li class="list-group-item">
                    ...
                    <div class="collapse show" id="Privacy">
                        <div class="card card-body">
                            <p>
                                يتيح تطبيق فاراداي للطلاب الراغبين في التعلم عبر الإنترنت،يكون الأشتراك عبر الأشتراك عن طريق أدارة تطبيق فاراداي و دفع اشتراك مقابل الخدمة ويتيح للمستخدم عددًا كبيرًا من شروحات المواد الدراسية مثل مادة الكيمياء و الفيزياء وغيرها من المواد .
                            </p>
                ...
                <li class="list-group-item">
                    ...
                    <div class="collapse show" id="Privacy">
                        <div class="card card-body">
                            <p>
                                يعتمد تطبيق فاراداي على نظام الاشتراك فى المواد الدراسية التى تريد البدء فى الدراسة فيها من باقة لكل مادة دراسية او مجموعة موادة دراسة او حتى حساب بريم
                            </p>
